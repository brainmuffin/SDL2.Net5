...
namespace SDL2.Net5
{
    public class SdlKeycode
    {
        ...
        public const int KMOD_CTRL = (int)SdlKeymod.KMOD_LCTRL | (int)SdlKeymod.KMOD_RCTRL;
        public const int KMOD_SHIFT = (int)SdlKeymod.KMOD_LSHIFT | (int)SdlKeymod.KMOD_RSHIFT;
        public const int KMOD_ALT = (int)SdlKeymod.KMOD_LALT | (int)SdlKeymod.KMOD_RALT;
        public const int KMOD_GUI = (int)SdlKeymod.KMOD_LGUI | (int)SdlKeymod.KMOD_RGUI;
